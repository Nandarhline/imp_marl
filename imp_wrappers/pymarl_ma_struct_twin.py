...
from struct_env.struct_envtwin import Struct_twin
...
class PymarlMAStruct(MultiAgentEnv):
    def __init__(self,
                 ...
                 # State contains the concatenation of digital twin observations
                 ...
                 obs_twin: bool = True,
                 # Obs contains the obs of the digital twin
    ...
    def get_obs_agent(self, agent_id):
        ...
        if self.obs_twin:
            obs = np.append(obs, self.struct_env.beliefs_twin[agent_id])
    ...
    def get_state(self):
        ...
        if self.state_twin:
            state = np.append(state, self.struct_env.beliefs_twin)
